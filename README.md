...
master-1 Coolify instance, with optional `staging` beside `main`. Stage uses the
same Coolify source setup as production, only a different branch. Calls the Coolify API directly and expects
